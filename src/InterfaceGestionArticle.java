/***********************************************************************
 * Module:  InterfaceGestionArticle.java
 * Author:  tasnim
 * Purpose: Defines the Class InterfaceGestionArticle
 ***********************************************************************/

import java.util.*;

/** @pdOid 64dac397-ecc7-4233-b87a-f4255e82c8c9 */
public class InterfaceGestionArticle {
   /** @pdRoleInfo migr=no name=InterfaceAccueilAdmin assc=association18 coll=java.util.Collection impl=java.util.HashSet mult=0..* */
   public java.util.Collection<InterfaceAccueilAdmin> interfaceAccueilAdmin;
   /** @pdRoleInfo migr=no name=GererRubrique assc=association34 coll=java.util.Collection impl=java.util.HashSet mult=0..* */
